...
class TestKVDBStaticObjectManager:
    ...
    def test_add_static_object(self):
        ...
        assert self.__static_object_manager.get_static_object(objectId=self.__STATIC_OBJECT_ID) == self.__test_static_object
    ...
    def test_add_static_object_with_same_id(self):
        ...
        with raises(StaticObjectAlreadyExistsException):
            self.__static_object_manager.add_static_object(object=sameIdStaticObject)
    ...
    def test_remove_static_object_and_try_get_it(self):
        ...
        with raises(UnknownStaticObjectException):
            self.__static_object_manager.get_static_object(objectId=self.__STATIC_OBJECT_ID)
    ...
    def test_update_static_object(self):
        ...
        assert self.__static_object_manager.get_static_object(objectId=self.__STATIC_OBJECT_ID) == newStaticObject

    def test_update_not_existent_static_object(self):
        with raises(UnknownStaticObjectException):
            self.__static_object_manager.update_static_object(objectId="missingStaticObjectId", object={})
